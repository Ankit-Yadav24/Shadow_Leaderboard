...
const LeaderboardTable = ({
  ...
  const handleSort = (field) => {
    if (
      !["rank", "overall", "phy", "chem", "maths", "accuracy"].includes(field)
    )
      return;
    if (sortField === field) {
      ...
      >
        <Table>
          ...
          <AnimatePresence mode="wait">
            <motion.tbody
              key={`page-${currentPage}-sort-${sortField || "default"}-${
