...
export function generateUserSubjectPerformance(currentUser) {
...
export function generateUserVsTopPerformers(data, currentUser) {
  const colors = getChartColors();
...
export function generateUserAccuracyComparison(data, currentUser) {
  const colors = getChartColors();
...
export function generateUserRankProgress(currentUser) {
  const colors = getChartColors();
...
export function generateAnalyticsData(data, currentUser) {
  if (!currentUser) {
    return {
